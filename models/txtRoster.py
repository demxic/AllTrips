...
from models.scheduleclasses import Line, Trip, Route, DutyDay, Itinerary, Airport, Flight, GroundDuty, Event
...
class Liner(object):
    ...
    def from_ground_itinerary(self, roster_day):
        ...
        duty_day = DutyDay()
        itinerary = self.build_itinerary(roster_day)
        # TODO : DataBase access should be done at the very end
        route = Route(name=roster_day['name'], origin=self.crew_member.base,
                      destination=self.crew_member.base, route_id=None)
