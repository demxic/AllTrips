...
page_number_RE: Pattern[str] = re.compile(r"""
    =+\d+=+
    """, re.VERBOSE | re.DOTALL)

trips_total_RE: Pattern[str] = re.compile(r"""
...
trip_RE: Pattern[str] = re.compile(r"""
...
dutyday_RE: Pattern[str] = re.compile(r'''
...
flights_RE: Pattern[str] = re.compile(r"""
